...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {coolcar.TripStatus|null} [staus] Trip staus
         */
        ...
        /**
         * Trip staus.
         * @member {coolcar.TripStatus} staus
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.staus = 0;
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.endPos = null;
                object.staus = options.enums === String ? "TS_NOT_SPECIFIED" : 0;
            }
            ...
            if (message.staus != null && message.hasOwnProperty("staus"))
                object.staus = options.enums === String ? $root.coolcar.TripStatus[message.staus] : message.staus;
            return object;
        };
