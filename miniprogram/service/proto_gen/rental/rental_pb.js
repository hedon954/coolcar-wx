...
export const rental = $root.rental = (() => {
    ...
    rental.v1 = (function() {
        ...
        v1.LocationStatus = (function() {
             ...
             * @property {string|null} [positionName] LocationStatus positionName
             */
            ...
            /**
             * LocationStatus positionName.
             * @member {string} positionName
             * @memberof rental.v1.LocationStatus
             * @instance
             */
            LocationStatus.prototype.positionName = "";
            ...
            LocationStatus.fromObject = function fromObject(object) {
                ...
                if (object.positionName != null)
                    message.positionName = String(object.positionName);
                return message;
            };
            ...
            LocationStatus.toObject = function toObject(message, options) {
                ...
                if (message.positionName != null && message.hasOwnProperty("positionName"))
                    object.positionName = message.positionName;
                return object;
            };
